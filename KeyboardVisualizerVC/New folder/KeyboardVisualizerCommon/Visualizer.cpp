...
THREAD afxthread(void *param)
{
	Visualizer* vis = static_cast<Visualizer*>(param);
	vis->AlienFXSDKUpdateThread();
	THREADRETURN
}
...
void Visualizer::AlienFXSDKUpdateThread()
{
	while (afx.SetLEDs(pixels_out->pixels))
	{
		Sleep(delay);
	}
}
